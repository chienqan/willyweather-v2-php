<?php
    ...
    {    
        ...
        public function __construct(Client $client, $id, $weather = [], $defaultValues = [])
        {
            $this->client = $client;
        ...
        protected function fetch($weather)
        {
            $params = [];
        ...
        protected function convertDateTimeStrings($result)
        {
        ...
        public function getForecasts($weather = ["forecasts" => ["weather"]])
        {
        ...
        public function getObservationalGraphs($weather = ["observationalGraphs" => ["dew-point"]])
        {
